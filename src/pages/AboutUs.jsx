...
const AboutUs = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 relative">
      ...
      <div className="pt-40 relative z-10 px-4 sm:px-6 lg:px-8">
        {/* Main Page Heading */}
        <h1 className="text-3xl sm:text-4xl font-bold text-center mb-2">
          About Us
        </h1>
        {/* Subtitle */}
        <h3 className="text-xl sm:text-2xl text-center text-gray-600 mb-8">
          Learn more about our mission, tools, and materials.
        </h3>
